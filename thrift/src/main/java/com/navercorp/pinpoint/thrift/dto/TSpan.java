...
public class TSpan implements org.apache.thrift.TBase<TSpan, TSpan._Fields>, java.io.Serializable, Cloneable, Comparable<TSpan> {
  ...
  private static final org.apache.thrift.protocol.TField REST_CONTROL_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("restControlName", org.apache.thrift.protocol.TType.STRING, (short)32);
  ...
  private String restControlName; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    REST_CONTROL_NAME((short)32, "restControlName");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 32: // REST_CONTROL_NAME
          return REST_CONTROL_NAME;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.REST_CONTROL_NAME, new org.apache.thrift.meta_data.FieldMetaData("restControlName", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public TSpan(TSpan other) {
    ...
    if (other.isSetRestControlName()) {
      this.restControlName = other.restControlName;
    }
  }
  ...
  public String getRestControlName() {
    return this.restControlName;
  }

  public void setRestControlName(String restControlName) {
    this.restControlName = restControlName;
  }

  public void unsetRestControlName() {
    this.restControlName = null;
  }

  /** Returns true if field restControlName is set (has been assigned a value) and false otherwise */
  public boolean isSetRestControlName() {
    return this.restControlName != null;
  }

  public void setRestControlNameIsSet(boolean value) {
    if (!value) {
      this.restControlName = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
      ...
      case REST_CONTROL_NAME:
        if (value == null) {
          unsetRestControlName();
        } else {
          setRestControlName((String)value);
        }
        break;
  ...
  public boolean equals(TSpan that) {
    ...
    boolean this_present_restControlName = true && this.isSetRestControlName();
    boolean that_present_restControlName = true && that.isSetRestControlName();
    if (this_present_restControlName || that_present_restControlName) {
      if (!(this_present_restControlName && that_present_restControlName))
        return false;
      if (!this.restControlName.equals(that.restControlName))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_restControlName = true && (isSetRestControlName());
    list.add(present_restControlName);
    if (present_restControlName)
      list.add(restControlName);
  ...
  public int compareTo(TSpan other) {
    ...
    lastComparison = Boolean.valueOf(isSetRestControlName()).compareTo(other.isSetRestControlName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRestControlName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.restControlName, other.restControlName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetRestControlName()) {
      if (!first) sb.append(", ");
      sb.append("restControlName:");
      if (this.restControlName == null) {
        sb.append("null");
      } else {
        sb.append(this.restControlName);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class TSpanStandardScheme extends StandardScheme<TSpan> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TSpan struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 32: // REST_CONTROL_NAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.restControlName = iprot.readString();
              struct.setRestControlNameIsSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSpan struct) throws org.apache.thrift.TException {
      ...
      if (struct.restControlName != null) {
        if (struct.isSetRestControlName()) {
          oprot.writeFieldBegin(REST_CONTROL_NAME_FIELD_DESC);
          oprot.writeString(struct.restControlName);
          oprot.writeFieldEnd();
        }
      }
