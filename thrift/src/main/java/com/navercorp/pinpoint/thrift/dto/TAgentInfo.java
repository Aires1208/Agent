...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2017-2-21")
public class TAgentInfo implements org.apache.thrift.TBase<TAgentInfo, TAgentInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TAgentInfo> {
  ...
  private static final org.apache.thrift.protocol.TField MAC_FIELD_DESC = new org.apache.thrift.protocol.TField("mac", org.apache.thrift.protocol.TType.STRING, (short)40);
  private static final org.apache.thrift.protocol.TField OS_FIELD_DESC = new org.apache.thrift.protocol.TField("os", org.apache.thrift.protocol.TType.STRING, (short)50);
  private static final org.apache.thrift.protocol.TField IS_DOCKER_FIELD_DESC = new org.apache.thrift.protocol.TField("isDocker", org.apache.thrift.protocol.TType.BOOL, (short)60);
  ...
  private boolean isDocker; // optional
  ...
  private static final int __ISDOCKER_ISSET_ID = 5;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.END_TIMESTAMP,_Fields.END_STATUS,_Fields.SERVER_META_DATA,_Fields.JVM_INFO,_Fields.MAC,_Fields.OS,_Fields.IS_DOCKER};
  ...
  static {
    ...
    tmpMap.put(_Fields.OS, new org.apache.thrift.meta_data.FieldMetaData("os", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.IS_DOCKER, new org.apache.thrift.meta_data.FieldMetaData("isDocker", org.apache.thrift.TFieldRequirementType.OPTIONAL,
  ...
  public void setIsDocker(boolean isDocker) {
    ...
    setIsDockerIsSet(true);
  }

  public void unsetIsDocker() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ISDOCKER_ISSET_ID);
  }

  /** Returns true if field isDocker is set (has been assigned a value) and false otherwise */
  public boolean isSetIsDocker() {
    return EncodingUtils.testBit(__isset_bitfield, __ISDOCKER_ISSET_ID);
  }

  public void setIsDockerIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ISDOCKER_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
      ...
      case IS_DOCKER:
        return Boolean.valueOf(isIsDocker());
  ...
  public boolean equals(TAgentInfo that) {
    ...
    boolean this_present_isDocker = true && this.isSetIsDocker();
    boolean that_present_isDocker = true && that.isSetIsDocker();
    if (this_present_isDocker || that_present_isDocker) {
      if (!(this_present_isDocker && that_present_isDocker))
        return false;
      if (this.isDocker != that.isDocker)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_isDocker = true && (isSetIsDocker());
    list.add(present_isDocker);
    if (present_isDocker)
      list.add(isDocker);
  ...
  public int compareTo(TAgentInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetIsDocker()).compareTo(other.isSetIsDocker());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsDocker()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.isDocker, other.isDocker);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TAgentInfoStandardScheme extends StandardScheme<TAgentInfo> {
        ...
        switch (schemeField.id) {
          ...
          case 60: // IS_DOCKER
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.isDocker = iprot.readBool();
              struct.setIsDockerIsSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAgentInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetIsDocker()) {
        oprot.writeFieldBegin(IS_DOCKER_FIELD_DESC);
        oprot.writeBool(struct.isDocker);
        oprot.writeFieldEnd();
      }
