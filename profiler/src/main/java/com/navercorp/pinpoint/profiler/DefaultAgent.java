...
public class DefaultAgent implements Agent {
    ...
    protected EnhancedDataSender createTcpDataSender(CommandDispatcher commandDispatcher) {
        ...
        this.client = ClientFactoryUtils.createPinpointClient(this.profilerConfig.getCollectorIp(),
                this.profilerConfig.getCollectorTcpServerPort(), clientFactory);
        return new TcpDataSender(client, this.profilerConfig.getCollectorTcpServerIp(),
                this.profilerConfig.getKafkaTcpPort());
    }
    ...
    protected DataSender createUdpSpanDataSender(int port, String threadName, int writeQueueSize, int timeout, int sendBufferSize) {
        return new UdpDataSender(this.profilerConfig.getLogstashIp(), port, threadName, writeQueueSize, timeout, sendBufferSize);
    }
