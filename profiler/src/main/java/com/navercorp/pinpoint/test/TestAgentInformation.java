...
public class TestAgentInformation extends AgentInformation {
    ...
    private static final String MAC = "44-87-FC-AD-A5-F2";
    private static final String OS = "windows7";
    private static final boolean IS_DOCKER = true;

    public TestAgentInformation() {
        super(AGENT_ID, APPLICATION_NAME, System.currentTimeMillis(), PID, MACHINE_NAME, HOST_IP, SERVICE_TYPE, JVM_VERSION, AGENT_VERSION, MAC, OS,IS_DOCKER);
    }
}
