...
public class Sample_04_Interceptors_In_A_Scope_Share_Value implements TransformCallback {
    ...
    public byte[] doInTransform(Instrumentor instrumentor, ClassLoader classLoader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws InstrumentException {
        ...
        outerMethod.addScopedInterceptor(
                "com.navercorp.pinpoint.plugin.sample._04_Interceptor_Scope__Data_Sharing.OuterMethodInterceptor", scope);
        ...
        innerMethod.addScopedInterceptor(
                "com.navercorp.pinpoint.plugin.sample._04_Interceptor_Scope__Data_Sharing.InnerMethodInterceptor",
                scope, ExecutionPolicy.INTERNAL);
