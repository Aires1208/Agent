 ...
 *
 */
public class UepTraceMetadataProvider implements TraceMetadataProvider {
...
//        context.addAnnotationKey(SamplePluginConstants.MY_RPC_RESULT_ANNOTATION_KEY);
        context.addServiceType(UepPluginConstants.UEP_SERVER);
        context.addServiceType(UepPluginConstants.UEP_CLIENT);
        context.addServiceType(UepPluginConstants.MINOS_SERVER);

        context.addAnnotationKey(UepPluginConstants.UEP_EMB_RESULT_ANNOTATION_KEY);
    }
