...
public class FServerBrokerBean_Requestx_Interceptor implements AroundInterceptor {
    private final PLogger logger = PLoggerFactory.getLogger(FServerBrokerBean_Requestx_Interceptor.class.getName());
    private final TraceContext traceContext;
    private final MethodDescriptor descriptor;

    public FServerBrokerBean_Requestx_Interceptor(TraceContext traceContext, MethodDescriptor descriptor) {
