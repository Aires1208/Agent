...
@TargetMethods({
        @TargetMethod(name = "syncRequest", paramTypes = {"com.zte.ums.uep.api.pfl.emb.EMessage"})
})
public class EmbServiceImpl_SyncRequest_Interceptor implements AroundInterceptor {
    private final PLogger logger = PLoggerFactory.getLogger(EmbServiceImpl_SyncRequest_Interceptor.class);
    private final MethodDescriptor descriptor;
    private final TraceContext traceContext;

    public EmbServiceImpl_SyncRequest_Interceptor(TraceContext traceContext, MethodDescriptor descriptor) {
