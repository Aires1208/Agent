 ...
 */
@TargetMethods({
        @TargetMethod(name = "requestBatchTryBest", paramTypes = {"java.awt.Component", "com.zte.ums.uep.api.pfl.finterface.FIMessage[]"}),
        @TargetMethod(name = "requestBatchTryBest", paramTypes = {"java.awt.Component", "com.zte.ums.uep.api.pfl.finterface.FIMessage[]", "boolean"})
})
public class FServiceProxy_RequestBatchTryBest_Interceptor implements AroundInterceptor {
    private final PLogger logger = PLoggerFactory.getLogger(FServiceProxy_RequestBatchTryBest_Interceptor.class.getName());
    private final TraceContext traceContext;
    private final MethodDescriptor descriptor;

    public FServiceProxy_RequestBatchTryBest_Interceptor(TraceContext traceContext, MethodDescriptor descriptor) {
