...
import com.zte.ums.uep.pfl.finterface.osf.FServerBrokerBean;
 ...
 */
@TargetMethods({
        @TargetMethod(name = "requestAsyn", paramTypes = {"com.zte.ums.uep.api.pfl.finterface.FIMessage"})
})
public class FServerBrokerBean_RequestAsyn_Interceptor implements AroundInterceptor {
    private final PLogger logger = PLoggerFactory.getLogger(FServerBrokerBean_RequestAsyn_Interceptor.class.getName());
    private final TraceContext traceContext;
    private final MethodDescriptor descriptor;
    FServerBrokerBean f;
    public FServerBrokerBean_RequestAsyn_Interceptor(TraceContext traceContext, MethodDescriptor descriptor) {
