 ...
 */
@TargetMethods({
        @TargetMethod(name = "requestBatchxAtomic", paramTypes = {"com.zte.ums.uep.api.pfl.finterface.FIMessage[]"})
})
public class FServerBrokerBean_RequestBatchxAtomic_Interceptor implements AroundInterceptor {
    private final PLogger logger = PLoggerFactory.getLogger(FServerBrokerBean_RequestBatchxAtomic_Interceptor.class.getName());
    private final TraceContext traceContext;
    private final MethodDescriptor descriptor;

    public FServerBrokerBean_RequestBatchxAtomic_Interceptor(TraceContext traceContext, MethodDescriptor descriptor) {
