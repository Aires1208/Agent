 ...
 */
@TargetMethods({
        @TargetMethod(name = "requestx", paramTypes = {"com.zte.ums.uep.api.pfl.finterface.FIMessage"}),
        @TargetMethod(name = "requestx", paramTypes = {"java.awt.Component", "com.zte.ums.uep.api.pfl.finterface.FIMessage"}),
        @TargetMethod(name = "requestx", paramTypes = {"com.zte.ums.uep.api.pfl.finterface.FIMessage", "int"}),
        @TargetMethod(name = "requestx", paramTypes = {"java.awt.Component", "com.zte.ums.uep.api.pfl.finterface.FIMessage", "boolean"}),
        @TargetMethod(name = "requestx", paramTypes = {"java.awt.Component", "com.zte.ums.uep.api.pfl.finterface.FIMessage", "int"})
})
public class FServiceProxy_Requestx_Interceptor implements AroundInterceptor {
    private final PLogger logger = PLoggerFactory.getLogger(FServiceProxy_Requestx_Interceptor.class.getName());
    private final TraceContext traceContext;
    private final MethodDescriptor descriptor;
    private boolean isNewTrace = false;

    public FServiceProxy_Requestx_Interceptor(TraceContext traceContext, MethodDescriptor descriptor) {
